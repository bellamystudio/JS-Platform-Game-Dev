...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        animSheet: new ig.AnimationSheet( 'media/boxhead.png', 16, 16 ),
        size: {x: 12, y:16},
        offset: {x: 2, y: 0},
        flip: false,
        maxVel: {x: 100, y: 150},
        ...
        setupAnimation: function(offset){
            ...
            this.addAnim('ice', .1, [2+offset,2+offset,2+offset,4+offset,5+offset,5+offset,5+offset,4+offset]);
            this.addAnim( 'jump', 1, [9] );
            this.addAnim( 'fall', 0.4, [6,7] );
            this.addAnim('throw', 0.25, [13,14]);            
        },
        ...
        update: function() {
        	...
        	//jump based on how long the jump button is pressed
        	if( this.standing && ig.input.pressed('jump') ) {
    ...
    EntityBullet = ig.Entity.extend({
        ...
        collides: ig.Entity.COLLIDES.PASSIVE,
        init: function( x, y, settings ) {
            this.parent( x + (settings.flip ? -4 : 7) , y+10, settings );
    ...
    EntityGrenade = ig.Entity.extend({
        ...
        bounceCounter: 0,
        init: function( x, y, settings ) {
            this.parent( x + (settings.flip ? -14 : 18), y, settings );
